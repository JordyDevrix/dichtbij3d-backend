...
@Entity
@Table(name = "hero_banner_settings")
class HeroBannerSettings(
    @Id
    var id: Int = 1,

    @Column(name = "slide_duration_seconds", nullable = false)
    var slideDurationSeconds: Int = 5,

    @Column(name = "show_for_logged_in_users", nullable = false)
    var showForLoggedInUsers: Boolean = false,
